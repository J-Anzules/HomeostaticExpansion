...
CondKeys = {'alpha'};
SampleSize = 50;
PctChange = 0.99; %What percentage should the initial conditions vary?
EntryNumber = 563;
PlotType = "Percentile"; % "Percentile" (10 and 90) or "Std" (1 std above and below the mean)
tx = 1:432; %Model is set up for per hour
%--------------------------------------------------------------------------------------------------------%
...
PlottingFillPrm(ModelRates, StatsOfCells, tx, PlotType, CondKeys, PctChange)
