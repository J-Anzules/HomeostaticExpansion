...
```{r, echo = FALSE}
library(scales)
ActivData = read.csv('C:/Laptop Backups/HomestaticExpansionProject/ModelData/TCellActivationSummary_EdittedinR.csv')
colnames(ActivData)
...
TregDF = read.csv('C:/Laptop Backups/HomestaticExpansionProject/ModelData/AfterCalculations.csv')
#Removing day 0, because it is always weird
