...
WTProl = read.csv('C:/Laptop Backups/HomestaticExpansionProject/Code/Modeling/Matlab/RawData/WTProl_D0.csv')
KOProl = read.csv('C:/Laptop Backups/HomestaticExpansionProject/Code/Modeling/Matlab/RawData/KOProl_D0.csv')
ActivatedWTSpleen = read.csv('C:/Laptop Backups/HomestaticExpansionProject/Code/Modeling/Matlab/RawData/ActivatedWTSpleen_D0.csv')
ActivatedKOSpleen = read.csv('C:/Laptop Backups/HomestaticExpansionProject/Code/Modeling/Matlab/RawData/ActivatedKOSpleen_D0.csv')
...
#=============================================================================================#
#--------------------------- Figure 2A - Early Activation Percentage--------------------------#
#=============================================================================================#
...
CD4CD69 =
  ...
  scale_x_continuous(breaks = c(0,5,10,15,18), limits=c(-0.3,18))+
...
#=============================================================================================#
#------------------------- Figure 2B - Early Activation Count --------------------------------#
#=============================================================================================#
...
#=============================================================================================#
#-------------------- Figure 2C - Non proliferating Activated T Cells % ----------------------#
#=============================================================================================#
...
NonProlActT_pct =
  ...
  theme(panel.background = element_rect(fill = "white", colour = "black"),
        ...
        panel.border = element_rect(color = "black",
                                    fill = "NA",
                                    size = panelBorder))+
  scale_y_continuous(breaks = c(40,60,80,100), limits = c(40, 100))+
  scale_x_continuous(breaks = c(0,5,10,15,18), limits=c(-0.3,18))+
  scale_color_manual(values = c(KOColor, WTColor))+
  guides(color = guide_legend("Legend"))
...
ggsave(file = "C:/Laptop Backups/HomestaticExpansionProject/Figures/ForPaper/Figure 1 - Wt vs KO/Figure2_V4_018Data.pdf", a,
       height = 11,
       width = 8)
