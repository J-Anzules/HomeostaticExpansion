...
ggplot(popSpln, aes(intage, OrganWeight, shape = Genotype)) + 
  ...
  theme(panel.background = element_rect(fill = "white", colour = "black", size = 2),
                 ...
                 legend.background = (element_rect(colour= "black", fill = "white")),
        axis.title.x = element_text(face="bold", colour="black", size=xAxisTextSize),
        axis.title.y = element_text(face = "bold", colour = "black",                                      angle = 90, size = yAxisTextSize),
        plot.title = element_text(lineheight=.8, face="bold", size = titleAxisTextSize),
        axis.ticks.length=unit(.25, "cm"),
        text = element_text(size=AxisTickSize))+
  stat_summary(aes(group=Genotype, color = Genotype), fun=mean, geom="line")+
...
ActivationDataSpln = subset(ActivationData, Organ == "Spleen")


#Changing total cell count to 10**6
ActivationDataSpln$NaiveCT = ActivationDataSpln$NoTregCD4CT - ActivationDataSpln$ActivatedCD4CT
ActivationDataSpln$NaiveCT = ActivationDataSpln$NaiveCT * 10**6
ggplot(ActivationDataSpln, aes(intage, NaiveCT, shape = Genotype)) +
  geom_point(position = position_dodge(1), size = 4)+
  scale_x_continuous(breaks = seq(0,18,2))+
  scale_y_continuous(breaks = seq(0,max(ActivationDataSpln$NaiveCT), length.out = 5), labels =label_scientific(digits = 2) )+
  labs(titles = "Naive T Cell Total Count", x = "Age in Days", y = "CD44-CD62L+")+
  theme(panel.background = element_rect(fill = "white", colour = "black", size = 2),
                 legend.key = element_rect(fill = "white", colour = "black"),
                 legend.background = (element_rect(colour= "black", fill = "white")),
        axis.title.x = element_text(face="bold", colour="black", size=xAxisTextSize),
        axis.title.y = element_text(face = "bold", colour = "black", size = yAxisTextSize),
        plot.title = element_text(lineheight=.8, face="bold", size = titleAxisTextSize),
        axis.ticks.length=unit(.25, "cm"),
        text = element_text(size=AxisTickSize))+
  stat_summary(aes(group=Genotype, color = Genotype), fun=mean, geom="line")
# ggsave("C:/Laptop Backups/HomestaticExpansionProject/Plots/HomeoPlots/Young/NaiveTCell_Count.png",
#        width = 5.5,
#        height = 4)
```
...
# View(pop)
# 
# pop56 = subset(pop, Age == 56 & Organ == "Spleen")
# pop56$Organ
# pop56$X4TregCT
# View(pop56)
#removing an outlier and Day 0
TregData = subset(pop,intage > 0 & Organ == "Spleen")
...
ggplot(TregData, aes(intage, X4TregCT, shape = Genotype)) + 
  ...
  stat_summary(aes(group=Genotype, color = Genotype), fun=mean, geom="line")+
  xlim(0, 58)+
  scale_x_break(c(20,53), scales=0.2, ticklabels=c(54, 56, 58))

# ggsave("C:/Laptop Backups/HomestaticExpansionProject/Plots/HomeoPlots/WithDay56/Treg_Count.png",
#        width = 7,
#        height = 4)
...
ggplot(TregData, aes(intage, X4TregRatio, shape = Genotype)) + 
  ...
  theme(panel.background = element_rect(fill = "white", colour = "black", size = 2),
                 ...
                 legend.background = (element_rect(colour= "black", fill = "white")),
        axis.title.x = element_text(face="bold", colour="black", size=xAxisTextSize),
        axis.title.y = element_text(face = "bold", colour = "black",angle = 90, 
                                    size = yAxisTextSize),
        plot.title = element_text(lineheight=.8, face="bold", size = titleAxisTextSize),
        axis.ticks.length=unit(.25, "cm"),
        text = element_text(size=AxisTickSize))+
  ...
  xlim(0, 58)+
  scale_x_break(c(20,53), scales=0.2, ticklabels=c(54, 56, 58))
# ggsave("C:/Laptop Backups/HomestaticExpansionProject/Plots/HomeoPlots/WithDay56/Treg_Pct.png",
#        width = 7,
#        height = 4)
...
library(ggplot2)
library(scales)
ActivationData = read.csv("C:/Laptop Backups/HomestaticExpansionProject/ModelData/ActivatedCD4pop.csv")
ActivationDataSpln = subset(ActivationData, Organ == "Spleen")
ActivationDataSpln$ActivatedCD4CT =ActivationDataSpln$ActivatedCD4CT * 10**6
ggplot(ActivationDataSpln, aes(intage, ActivatedCD4CT, shape = Genotype)) + 
  geom_point(position = position_dodge(1), size = 4)+
  scale_x_continuous(breaks =seq(0,18,2))+
  scale_y_continuous(breaks = seq(0, max(ActivationDataSpln$ActivatedCD4CT), 
                                  length.out = 5), 
  ...
  theme(panel.background = element_rect(fill = "white", colour = "black", size = 2),
        ...
        text = element_text(size=AxisTickSize))+
  stat_summary(aes(group=Genotype, color = Genotype), fun=mean, geom="line")
# ggsave("C:/Laptop Backups/HomestaticExpansionProject/Plots/HomeoPlots/Young/ActivatedTCells.pdf",
#        width = 5.5,
#        height = 4)
```
...
ggplot(CD69Data, aes(Age, CD4CD69_pct, shape = Genotype)) + 
  ...
  theme(panel.background = element_rect(fill = "white", colour = "black", size = 2),
        ...
        text = element_text(size=AxisTickSize))+
  stat_summary(aes(group=Genotype, color = Genotype), fun=mean, geom="line")
# ggsave("C:/Laptop Backups/HomestaticExpansionProject/Plots/HomeoPlots/Young/CD69_Pct.png",
#        width = 5.5,
#        height = 4)
...
# CD44+CD62L+
```{r}
CD69Data = read.csv('C:/Laptop Backups/HomestaticExpansionProject/ModelData/TCellActivationSummary_filled.csv') 
...
ggplot(CD69Data, aes(Age, CD4CD44CD62L_pct, shape = Genotype)) + 
  ...
  theme(panel.background = element_rect(fill = "white", colour = "black", size = 2),
        ...
        text = element_text(size=AxisTickSize))+
  stat_summary(aes(group=Genotype, color = Genotype), fun=mean, geom="line")
# ggsave("C:/Laptop Backups/HomestaticExpansionProject/Plots/HomeoPlots/Young/CD44CD62.png",
#        width = 5.5,
#        height = 4)
...
#Setting up the data
ProliferatingWT = subset(WTProl, select = c("ActivatedProlCT", "NaiveProlCT", "X4TregProlCT", "Age" ))
LongProliferatingWT = gather(ProliferatingWT, variable, value, -Age)
# ActivatedTProlWT = subset(WTProl, select = c("ActivatedProlCT", "Age"))
# LongActivatedTProlWT = gather(ActivatedTProlWT, variable, value, -Age)
# LongProliferatingWT = rbind(LongProliferatingWT, LongActivatedTProlWT)

#Changing the Names and order
LongProliferatingWT$variable = factor(LongProliferatingWT$variable, levels = c("ActivatedProlCT", "NaiveProlCT", "X4TregProlCT"), 
                              labels = c("Activated T cells","Naive T cells", "Tregs"))

#Creating Y axis label
Ylabel = expression(Cell ~ Counts ~ (10^6))

ggplot(LongProliferatingWT, aes(x = Age, y = value, color = variable)) + 
  geom_point(position = position_dodge(1), size = 2)+
  stat_summary(aes(group=variable, color = variable), fun=mean, geom="line")+
  labs(titles = "WT Proliferating Cells", x = "Age in Days", y = Ylabel)+
  theme(panel.background = element_rect(fill = "white", colour = "black", size = 2),
                 legend.key = element_rect(fill = "white", colour = "black"),
                 legend.background = (element_rect(colour= "black", fill = "white")),
        axis.title.x = element_text(face="bold", colour="black", size=xAxisTextSize),
...
#Setting up the data
ProliferatingKO = subset(KOProl, select = c("ActivatedProlCT", "NaiveProlCT", "X4TregProlCT", "Age" ))
LongProliferatingKO = gather(ProliferatingKO, variable, value, -Age)
#Changing the Names and order
LongProliferatingKO$variable = factor(LongProliferatingKO$variable, levels = c("ActivatedProlCT", "NaiveProlCT", "X4TregProlCT"), 
                              labels = c("Activated T cells","Naive T cells", "Tregs"))
Ylabel = expression(Cell ~ Counts ~ (10^6))
ggplot(LongProliferatingKO, aes(x = Age, y = value, color = variable)) + 
  geom_point(position = position_dodge(1), size = 2)+
  stat_summary(aes(group=variable, color = variable), fun=mean, geom="line")+
  labs(titles = "KO Proliferating cells", x = "Age in Days", y = Ylabel)+
  theme(panel.background = element_rect(fill = "white", colour = "black", size = 2),
                 legend.key = element_rect(fill = "white", colour = "black"),
                 legend.background = (element_rect(colour= "black", fill = "white")),
        axis.title.x = element_text(face="bold", colour="black", size=xAxisTextSize),
        ...
        axis.ticks.length=unit(.25, "cm"),
        text = element_text(size=AxisTickSize))+
  scale_y_continuous(limits=c(0, 1700000), breaks = c(0, 425000, 850000, 1275000, 1700000), 
                     labels = c(0, 0.43, 0.85, 1.28, 1.70))+
  scale_x_continuous(breaks = c(0,5,10,15,18))+
  scale_color_manual(values = c("#CA3537", "#82CA35", "#35CAC8", "#7D35CA"))+
  guides(color = guide_legend("Legend"))
# max(LongProliferatingWT$value)
# max(LongProliferatingKO$value)
# seq(0,1700000, length.out=5)
```
...
ActivatedWTSpleen$ThymicNaiveWT = ActivatedWTSpleen$ThymicNaive
#######################################
#           Wild Type
#######################################

#Setting up Data
ThymicNaiveWT = subset(ActivatedWTSpleen, select = c("ThymicNaiveWT", "Age"))
LongThymicNaiveWT = gather(ThymicNaiveWT, variable, value, -Age)

ThymicNaiveKO = subset(ActivatedKOSpleen, select = c("ThymicNaive", "Age"))
LongThymicNaiveKO = gather(ThymicNaiveKO, variable, value, -Age)
LongThymicNaive = rbind(LongThymicNaiveWT, LongThymicNaiveKO)

LongThymicNaive$variable = factor(LongThymicNaive$variable, levels = c("ThymicNaiveWT", "ThymicNaive"), labels = c("WT", "KO"))

# #Creating Y axis label
# Ylabel = expression(Cell ~ Counts)
# 
# ggplot(LongThymicNaive, aes(x = Age, y = value, color = variable)) + 
#   geom_point(position = position_dodge(1), size = 2)+
#   stat_summary(aes(group=variable, color = variable), fun=mean, geom="line")+
...
#Another one
ggplot(LongThymicNaive, aes(Age, value, shape = variable)) + 
  geom_point(position = position_dodge(1), size = 4)+
  #scale_x_continuous(breaks = seq(0,57,4), limits = c(-0.8,56))+
  # scale_y_continuous(breaks = seq(0,max(popThym$OrganWeight, na.rm = TRUE), 
  #                                 length.out =5), labels = label_number(accuracy = 0.11))+
...
#Another one
ggplot(LongThymicTregs, aes(Age, value, shape = variable)) + 
  geom_point(position = position_dodge(1), size = 4)+
  #scale_x_continuous(breaks = seq(0,57,4), limits = c(-0.8,56))+
  # scale_y_continuous(breaks = seq(0,max(popThym$OrganWeight, na.rm = TRUE), 
  #                                 length.out =5), labels = label_number(accuracy = 0.11))+
...
#DNU Plotting Naive and Thymus Derived Tregs (Uneeded)
```{r}
# dfTreg = read.csv("C:/Laptop Backups/HomestaticExpansionProject/ModelData/ActivatedCD4pop.csv")
# dfTreg = subset(dfTreg, Organ == "Spleen")
...
# 
# dfTreg$AllTregs = dfTreg$X4TregCT * 10**6
# 
# #Naive Derived
...
#         text = element_text(size=AxisTickSize))+
#   stat_summary(aes(group=Genotype, color = Genotype), fun=mean, geom="line")
# ggsave("C:/Laptop Backups/HomestaticExpansionProject/Plots/HomeoPlots/Young/NaiveDerivedTregs.png",
#        width = 5.5,
#        height = 4)
# #Thymus Derived
...
#         text = element_text(size=AxisTickSize))+
#   stat_summary(aes(group=Genotype, color = Genotype), fun=mean, geom="line")
# ggsave("C:/Laptop Backups/HomestaticExpansionProject/Plots/HomeoPlots/Young/ThymusDerivedTregs.png",
#        width = 5.5,
#        height = 4)
# 
# #All Tregs
...
#         text = element_text(size=AxisTickSize))+
#   stat_summary(aes(group=Genotype, color = Genotype), fun=mean, geom="line")
# ggsave("C:/Laptop Backups/HomestaticExpansionProject/Plots/HomeoPlots/Young/AllTregs.png",
#        width = 5.5,
#        height = 4)
```

#DNU Calculating Treg Frequency that did not come from Thymus (Testing)
```{r}
# pop = read.csv("C:/Laptop Backups/HomestaticExpansionProject/ModelData/AfterCalculations.csv")
# library(dplyr)
# library("Rmisc")
...
#DNU Testing geom line and error bars (Testing)
```{r}
# 
# #+++++++++++++++++++++++++
...
#DNU WT n KO Proliferating differences
```{r}
# library(tidyr)
# library(ggplot2)
# KOProl = read.csv('C:/Laptop Backups/HomestaticExpansionProject/Code/Modeling/Matlab/RawData/KOProl.csv')
...
#DNU All Treg sources
```{r}
# library(tidyr)
# library(ggplot2)
# popActiv = read.csv('C:/Laptop Backups/HomestaticExpansionProject/Code/Modeling/Matlab/RawData/ActivatedWTSpleen.csv')
...
# 
# 
# popActivKO = read.csv('C:/Laptop Backups/HomestaticExpansionProject/Code/Modeling/Matlab/RawData/ActivatedKOSpleen.csv')
...
#DNU Activated T cell proliferation comparison
```{r}
...
# 
# #Preparing the data
# popNaive = subset(ActivatedWTSpleen, select = c("Age", "NaiveCT", "ThymicNaive"))
# prolNaive = subset(WTProl, select = c("Age", "NaiveProlCT"))
# Naivepop = merge(popNaive, prolNaive)
# 
# longNaivepop = gather(Naivepop, variable, value, -Age)
# 
...
# 
# 
# ggplot(longNaivepop, aes(x = Age, y = value, color = variable)) + 
#   geom_point(position = position_dodge(1), size = 2)+
#   stat_summary(aes(group=variable, color = variable), fun=mean, geom="line")+
#   labs(titles = "WT Naive and sub populations", x = "Age in Days", y = "Treg counts")+
#   theme(panel.background = element_rect(fill = "white", colour = "black", size = 2),
#                  legend.key = element_rect(fill = "white", colour = "black"),
#                  legend.background = (element_rect(colour= "black", fill = "white")),
#         axis.title.x = element_text(face="bold", colour="black", size=xAxisTextSize),
...
# 
# #Preparing the data
# popNaiveKO = subset(ActivatedKOSpleen, select = c("Age", "NaiveCT", "ThymicNaive"))
# prolNaiveKO = subset(KOProl, select = c("Age", "NaiveProlCT"))
# NaivepopKO = merge(popNaiveKO, prolNaiveKO)
# 
# longNaivepopKO = gather(NaivepopKO, variable, value, -Age)
# 
# # plot(ActivatedWTSpleen$Age,ActivatedWTSpleen$NaiveCT, pch = 5,
# #      main = "WT Naive T Cell Sub Populations",
# #      ylab = "Naive T Cell Counts",
...
# 
# 
# ggplot(longNaivepopKO, aes(x = Age, y = value, color = variable)) + 
#   geom_point(position = position_dodge(1), size = 2)+
#   stat_summary(aes(group=variable, color = variable), fun=mean, geom="line")+
#   labs(titles = "WT Naive and sub populations", x = "Age in Days", y = "Treg counts")+
#   theme(panel.background = element_rect(fill = "white", colour = "black", size = 2),
