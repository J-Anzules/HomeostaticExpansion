...
#------------------------      CD69 %    ------------------------#
#----------------------------------------------------------------#
# What this data is related to in figure 1:
#  - pct_CD4_CD44_pos_CD62L_neg = Naive 
...
results_activated_spleen$passed
...
file_path <- "C:/Users/jonan/Documents/HomeostaticExpansion/Manuscript/Figures/P-value Table/pvalueTable4_AllWilcox.csv"
...
perform_t_test_for_column(ActivatedWTSpleen, ActivatedKOSpleen, "EarlyActivatedCD4CT")
...
# 
# 
# #------- Before I removed the Shapiro wilks result influence -------------------
# 
# 
...
d18_WT = subset(ActivatedWTSpleen, Age == 18)
d18_KO = subset(ActivatedKOSpleen, Age == 18)

mean(d18_WT$X4TregCT)
mean(d18_KO$X4TregCT)

??t.test()
t.test(d18_WT$X4TregCT, d18_KO$X4TregCT, alternative = "greater" )



koprol_d18 = subset(KOProl, Age == 18)
koprol_d18$X4TregProlCT
