...
ActivationData = read.csv("C:/Laptop Backups/HomestaticExpansionProject/ModelData/ActivatedCD4pop2_D0.csv")
...
#KO has more proliferation, we are assuming that the extra proliferation ratio is the activated T cells proliferating
...
ActivationDataSpleen$NonProlActivatedRatio = 1 - ActivationDataSpleen$ActivatedProlRatio 
...
ActivatedKOSpleen$NonProlActivatedCT = ActivatedKOSpleen$NonProlActivatedRatio * ActivatedKOSpleen$ActivatedCD4CT
ActivatedWTSpleen$NonProlActivatedCT = ActivatedWTSpleen$NonProlActivatedRatio * ActivatedWTSpleen$ActivatedCD4CT
...
MyColumns = c("FileID", "Organ", "Age", "Genotype", "intage", "NaiveCT", 
              ...
              "ActivatedProlCT", "NaiveProlCT", "ThymicNaive", 
              "ActivatedNaiveCT", "X4TregRatio", "NonProlActivatedRatio",
              "NonProlActivatedCT", 
              "ActivatedProlRatio",
              # "ActivatedNonProlCT", 
              "EarlyActivatedCD4CT")
...
write.csv(WTProl, 'C:/Laptop Backups/HomestaticExpansionProject/Code/Modeling/Matlab/RawData/WTProl_D0.csv')
write.csv(KOProl, 'C:/Laptop Backups/HomestaticExpansionProject/Code/Modeling/Matlab/RawData/KOProl_D0.csv')
write.csv(ActivatedWTSpleen, 'C:/Laptop Backups/HomestaticExpansionProject/Code/Modeling/Matlab/RawData/ActivatedWTSpleen_D0.csv')
write.csv(ActivatedKOSpleen, 'C:/Laptop Backups/HomestaticExpansionProject/Code/Modeling/Matlab/RawData/ActivatedKOSpleen_D0.csv')
