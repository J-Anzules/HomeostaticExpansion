...
pop = read.csv('C:/Laptop Backups/HomestaticExpansionProject/ModelData/Version8_Batchprocsesing.csv',
...
# CD69df = read.csv("C:/Laptop Backups/HomestaticExpansionProject/T cell Activation Summary_Jon.csv", header = FALSE, na.strings=c("","NA"))
...
# 
ActivData = read.csv("C:/Laptop Backups/HomestaticExpansionProject/ModelData/TCellActivationSummary_filled.csv")
...
# write.csv(ActivData, "C:/Laptop Backups/HomestaticExpansionProject/ModelData/TCellActivationSummary_EdittedinR_D0.csv")
...
write.csv(pop, 'C:/Laptop Backups/HomestaticExpansionProject/ModelData/AfterCalculations_D0.csv')
# write.csv(CD69df, 'C:/Laptop Backups/HomestaticExpansionProject/ModelData/CD69DataFromGen_D0.csv')
write.csv(ActivData, "C:/Laptop Backups/HomestaticExpansionProject/ModelData/TCellActivationSummary_EdittedinR_D0.csv")
write.csv(popNoInc, "C:/Laptop Backups/HomestaticExpansionProject/ModelData/NaiveTregDifferentiation_D0.csv")
